 ...
 * 
 */
@WebServiceClient(name = "BankWS", targetNamespace = "http://tpjaxws.sid.org/", wsdlLocation = "http://0.0.0.0:8084/?wsdl")
public class BankWS
    extends Service
{
    ...
    private static final QName BANKWS_QNAME = new QName("http://tpjaxws.sid.org/", "BankWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://0.0.0.0:8084/?wsdl");
    ...
    public BankService getBankServicePort() {
        return super.getPort(new QName("http://tpjaxws.sid.org/", "BankServicePort"), BankService.class);
    }
    ...
    public BankService getBankServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://tpjaxws.sid.org/", "BankServicePort"), BankService.class, features);
    }
